...
val i2 = <!CLASS_LITERAL_LHS_NOT_A_CLASS!><!WRONG_NUMBER_OF_TYPE_ARGUMENTS!>A<*>.Inner<*><!>::class<!>
val i3 = <!CLASS_LITERAL_LHS_NOT_A_CLASS!><!WRONG_NUMBER_OF_TYPE_ARGUMENTS!>A<Int>.Inner<CharSequence><!>::class<!>
