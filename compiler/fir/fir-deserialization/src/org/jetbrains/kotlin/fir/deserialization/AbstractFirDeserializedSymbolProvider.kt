...
abstract class AbstractFirDeserializedSymbolProvider(
    ...
    /**
     * This property might contain more than just callables, so it's not the same as `getPackageNamesWithTopLevelCallables`.
     */
    ...
    override val symbolNamesProvider: FirSymbolNamesProvider = object : FirSymbolNamesCache(session) {
