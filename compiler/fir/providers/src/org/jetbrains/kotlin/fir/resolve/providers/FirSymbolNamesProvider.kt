...
abstract class FirSymbolNamesProvider {
     ...
     * [FirSymbolProvider] can provide generated function types. The value should be constant.
     */
     ...
     */
    open fun mayHaveSyntheticFunctionType(classId: ClassId): Boolean = false
